      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
          <ul>
            ...
            <li>
              <a href="logout.jsp"><i class="fa fa-eject fa-fw"></i>Sign Out</a>
            </li>
          </ul>
        </nav>
      </div>
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li>
                  <a href="../../Homepage/homelogin.jsp">Home HGCE-PMS</a>
                </li>
                <li>
                  <a href="../../ContactUs/contact.jsp">Contact Us</a>
                </li>
                <li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Welcome to HGCE-PMS</h2>
              <hr>
              ...
              <div class="templatemo-content-widget white-bg">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p>Brace yourself for the Events that will take ur breath away. Get Started and be a Part of HGCE-PMS Family</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <footer class="text-right">
            		<p>Copyright &copy; 2022 HGCE | Developed by
              <a>200240107528/29/30</a>
			  </p>
          </footer>
        </div>
      </div>
